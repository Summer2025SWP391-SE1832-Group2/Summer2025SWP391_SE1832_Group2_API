...
namespace SWP391_BDNAT_API.Controllers
{
    ...
    public class SampleCollectionScheduleController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<SampleCollectionScheduleDTO>>> GetAllSchedules()
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<bool>> CreateSchedule([FromBody] SampleCollectionScheduleDTO scheduleDto)
        {
            try
            {             
